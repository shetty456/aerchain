    ...
    <div className="mx-auto max-w-5xl">
      <div>
        ...
        <p className="mt-2 text-sm text-[var(--muted)]">
          AI interprets the question. Qualification rules and arithmetic run
      ...
      <div className="mt-5 flex rounded-xl border border-[var(--line-strong)] bg-white p-2">
        <input
          value={question}
      ...
      <div className="mt-4 text-sm leading-6 text-[var(--muted)]">
        ...
        {operation === "UNRESOLVED_ITEMS" && (
          <p>
            ...
            vendor-line responses remain unresolved or ineligible.
          </p>
        )}
