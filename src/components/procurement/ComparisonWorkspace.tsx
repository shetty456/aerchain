...
type ComparisonPayload = {
  ...
  vendors: Array<{
    ...
    clarification: { status: 'GENERATING' | 'SENT' | 'RESPONSE_RECEIVED' | 'REPROCESSING' | 'COMPLETED' | 'FAILED'; questions?: string[]; error?: string } | null;
  }>;
};
